...
public class ReportController {
    ...
    @PostMapping("/type")
    @Operation(summary = "보고서 목록 조회", description = "특정 사용자의 보고서 유형에 따른 보고서 목록을 조회합니다.")
    @ApiResponse(responseCode = "200", description = "보고서 목록 조회 성공", content = @Content(schema = @Schema(hidden = true)))
    @ApiResponse(responseCode = "404", description = "보고서 목록 조회 실패", content = @Content(schema = @Schema(hidden = true)))
